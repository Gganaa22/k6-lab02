...
Манай 5 VU baseline хэмжилтийн p95 утга 1.26s (1260ms) гарсан тул SLO threshold-ийг baseline-аас 1.5 дахин их байхаар тооцож `p(95) < 1890ms` (1260ms × 1.5 = 1890ms) болон `http_req_failed < 1%` байхаар тохируулсан. `thresholds_script.js` дээр уг утгаар PASS үр дүн авсан бөгөөд хатуу тохируулж (500ms) FAIL үр дүнг шалгаж баталгаажуулсан.
...
6. Тодорхойлсон SLO нь бодит сүлжээний хугацаанд тааруулсан (1890ms) үед PASS гарсан бол хатуу тохируулсан (500ms) үед FAIL болж, quality gate ажиллах зарчмыг харууллаа.
